...
_PARTDESIGN_ESSENTIALS = (
    ...
    "- Link properties READ BACK in the shape they were declared. Profile and a "
    "dress-up's Base are one (obj, ['Sub']) tuple; Sections and "
    "AttachmentSupport are lists of those tuples. So it's o.Profile[0] and "
    "[s[0] for s in o.Sections] -- s.Name on a Sections entry is an "
    "AttributeError. BaseFeature, Originals and Group hold plain objects.\n"
